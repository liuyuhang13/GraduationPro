...
mex OPTIMFLAGS="-O3" -largeArrayDims -O ompmex.c mexutils.c ompcore.c omputils.c myblas.c ompprof.c -output ompmex

disp('Compiling omp2mex...');
%mex('omp2mex.c',ompsources{:},compile_params{:});
mex OPTIMFLAGS="-O3" -largeArrayDims -O omp2mex.c mexutils.c ompcore.c omputils.c myblas.c ompprof.c -output omp2mex
